...
cmake \
  ...
  -D CMAKE_EXE_LINKER_FLAGS=-L${usr_local_lib}\ -fuse-ld=lld \
  -D CMAKE_MODULE_LINKER_FLAGS=-L${usr_local_lib}\ -fuse-ld=lld \
  -D CMAKE_SHARED_LINKER_FLAGS=-L${usr_local_lib}\ -fuse-ld=lld \
